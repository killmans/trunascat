...
class ClucHAnix_BB_RPB_MOD(IStrategy):
    ...
    buy_params = {
    "antipump_threshold": 0.051,  # value loaded from strategy
        "buy_btc_safe_1d": -0.289,  # value loaded from strategy
        "clucha_bbdelta_close": 0.04196,  # value loaded from strategy
        "clucha_bbdelta_tail": 1.15253,  # value loaded from strategy
        "clucha_close_bblower": 0.03624,  # value loaded from strategy
        "clucha_closedelta_close": 0.02893,  # value loaded from strategy
        "clucha_enabled": True,  # value loaded from strategy
        "clucha_rocr_1h": 0.75386,  # value loaded from strategy
        "cofi_adx": 2,  # value loaded from strategy
        "cofi_ema": 0.927,  # value loaded from strategy
        "cofi_enabled": True,  # value loaded from strategy
        "cofi_ewo_high": 4.855,  # value loaded from strategy
        "cofi_fastd": 13,  # value loaded from strategy
        "cofi_fastk": 2,  # value loaded from strategy
        "ewo_1_enabled": True,  # value loaded from strategy
        "ewo_1_rsi_14": 45,  # value loaded from strategy
        "ewo_1_rsi_4": 19,  # value loaded from strategy
        "ewo_candles_buy": 5,  # value loaded from strategy
        "ewo_candles_sell": 30,  # value loaded from strategy
        "ewo_high": 3.535,  # value loaded from strategy
        "ewo_high_offset": 0.83699,  # value loaded from strategy
        "ewo_low": -15.871,  # value loaded from strategy
        "ewo_low_enabled": True,  # value loaded from strategy
        "ewo_low_offset": 1.09056,  # value loaded from strategy
        "ewo_low_rsi_4": 37,  # value loaded from strategy
        "lambo1_ema_14_factor": 1.045,  # value loaded from strategy
        "lambo1_enabled": True,  # value loaded from strategy
        "lambo1_rsi_14_limit": 59,  # value loaded from strategy
        "lambo1_rsi_4_limit": 60,  # value loaded from strategy
        "lambo2_ema_14_factor": 1.106,  # value loaded from strategy
        "lambo2_enabled": True,  # value loaded from strategy
        "lambo2_rsi_14_limit": 12,  # value loaded from strategy
        "lambo2_rsi_4_limit": 29,  # value loaded from strategy
        "local_trend_bb_factor": 0.859,  # value loaded from strategy
        "local_trend_closedelta": 10.059,  # value loaded from strategy
        "local_trend_ema_diff": 0.073,  # value loaded from strategy
        "local_trend_enabled": True,  # value loaded from strategy
        "nfi32_cti_limit": -0.86656,  # value loaded from strategy
        "nfi32_enabled": True,  # value loaded from strategy
        "nfi32_rsi_14": 3,  # value loaded from strategy
        "nfi32_rsi_4": 68,  # value loaded from strategy
        "nfi32_sma_factor": 0.99852,  # value loaded from strategy
